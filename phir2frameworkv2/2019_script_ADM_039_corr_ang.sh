...
trajsPath="/home/phi/Documents/Datasets/FOTOS-ADM-SEQUOIA-18_ABRIL/Imagens/0039/"
Trajs=(
"traj"
)
...
Configs=(
"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000 -mndvw 6 -mindviw 1 -msc 0 -ndvit 1 -minsc 0.1 -maxsc 3 -msimp 0 -mappp 1 -pdm 1 -fit 0 -inids 140 -iniexec 150 -fimds 430 -fiexec 430 -multgaussmsk 0.25 -cmppar 0 -corrpxpos 0"
"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000 -mndvw 6 -mindviw 1 -msc 0 -ndvit 1 -minsc 0.1 -maxsc 3 -msimp 0 -mappp 1 -pdm 1 -fit 0 -inids 140 -iniexec 150 -fimds 430 -fiexec 430 -multgaussmsk 0.25 -cmppar 1 -corrpxpos 0"
"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000 -mndvw 6 -mindviw 1 -msc 0 -ndvit 1 -minsc 0.1 -maxsc 3 -msimp 0 -mappp 1 -pdm 1 -fit 0 -inids 140 -iniexec 150 -fimds 430 -fiexec 430 -multgaussmsk 0.25 -cmppar 0 -corrpxpos 1"


"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000 -mndvw 6 -mindviw 1 -msc 1 -ndvit 1 -minsc 0.1 -maxsc 3 -msimp 0 -mappp 1 -pdm 7 -fit 0 -inids 140 -iniexec 150 -fimds 430 -fiexec 430 -multgaussmsk 0.25 -cmppar 0 -corrpxpos 0"
"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000 -mndvw 6 -mindviw 1 -msc 1 -ndvit 1 -minsc 0.1 -maxsc 3 -msimp 0 -mappp 1 -pdm 7 -fit 0 -inids 140 -iniexec 150 -fimds 430 -fiexec 430 -multgaussmsk 0.25 -cmppar 1 -corrpxpos 0"
"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000 -mndvw 6 -mindviw 1 -msc 1 -ndvit 1 -minsc 0.1 -maxsc 3 -msimp 0 -mappp 1 -pdm 7 -fit 0 -inids 140 -iniexec 150 -fimds 430 -fiexec 430 -multgaussmsk 0.25 -cmppar 0 -corrpxpos 1"
...
do
	...
	do
		...
		do
			...
			#####do            
                                resultPath="/home/phi/Dropbox/experimentos/ADM 2019/0039/ADM_039_MapasTerra_corr_ang/${MapsNames[$m]}/$traj/${Outputs[$c]}/"
