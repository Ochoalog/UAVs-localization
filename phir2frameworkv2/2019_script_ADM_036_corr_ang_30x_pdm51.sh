...
"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000 -mndvw 6 -mindviw 1 -msc 1 -ndvit 1 -minsc 0.1 -maxsc 3 -msimp 0 -mappp 1 -pdm 51 -fit 0 -inids 115 -iniexec 199 -fimds 456 -fiexec 394 -multgaussmsk 0.25 -cmppar 1 -corrpxpos 0"
"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000 -mndvw 6 -mindviw 1 -msc 1 -ndvit 1 -minsc 0.1 -maxsc 3 -msimp 0 -mappp 1 -pdm 51 -fit 0 -inids 115 -iniexec 199 -fimds 456 -fiexec 394 -multgaussmsk 0.25 -cmppar 0 -corrpxpos 1"
...
do
	...
	do
		...
		do
			...
			#####do            
                                resultPath="/home/phi/Dropbox/experimentos/ADM 2019/0036/ADM_036_MapasTerra_corr_ang_30x_pdm51/${MapsNames[$m]}/$traj/${Outputs[$c]}/"
