...
Configs=(
"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000 -mndvw 6 -mindviw 1 -msc 1 -ndvit 1 -minsc 0.1 -maxsc 3 -msimp 0 -mappp 1 -pdm 51 -fit 0 -inids 140 -iniexec 150 -fimds 430 -fiexec 430 -multgaussmsk 0.25"
)

Outputs=(     
"mndvw_6_20k_pdm_51_OK_gausmsk_025" # MSC  
)
