...
Configs=(
"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000  -msc 1 -ndvit 1 -minsc 0.5 -maxsc 5 -msimp 0 -mappp 1 -pdm 51 -fit 0 -inids 186 -iniexec 390 -fimds 719 -fiexec 613 -alfagaussmsk 1 -cmppar 0 -corrpxpos 0 -betaweight 1"

"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000  -msc 1 -ndvit 1 -minsc 0.5 -maxsc 5 -msimp 0 -mappp 1 -pdm 51 -fit 0 -inids 186 -iniexec 390 -fimds 719 -fiexec 613 -alfagaussmsk 1 -cmppar 0 -corrpxpos 0 -betaweight 2"

"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000  -msc 1 -ndvit 1 -minsc 0.5 -maxsc 5 -msimp 0 -mappp 1 -pdm 51 -fit 0 -inids 186 -iniexec 390 -fimds 719 -fiexec 613 -alfagaussmsk 1 -cmppar 0 -corrpxpos 0 -betaweight 4"

"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000  -msc 1 -ndvit 1 -minsc 0.5 -maxsc 5 -msimp 0 -mappp 1 -pdm 51 -fit 0 -inids 186 -iniexec 390 -fimds 719 -fiexec 613 -alfagaussmsk 1 -cmppar 0 -corrpxpos 0 -betaweight 8"

"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000  -msc 1 -ndvit 1 -minsc 0.5 -maxsc 5 -msimp 0 -mappp 1 -pdm 51 -fit 0 -inids 186 -iniexec 390 -fimds 719 -fiexec 613 -alfagaussmsk 1 -cmppar 0 -corrpxpos 0 -betaweight 16"

"-s BRIEF diff-cie2000 15 -bp 256 -blt 0.5 -bmt 4 -bm 10 -par 50000  -msc 1 -ndvit 1 -minsc 0.5 -maxsc 5 -msimp 0 -mappp 1 -pdm 51 -fit 0 -inids 186 -iniexec 390 -fimds 719 -fiexec 613 -alfagaussmsk 1 -cmppar 0 -corrpxpos 0 -betaweight 32"
)
...
do
	...
	do
		...
		do
			...
			#####do            
                                resultPath="/home/phi/Dropbox/experimentos/UFRGS VET/UFRGS_VET_390_613_50K_apenas_beta/${MapsNames[$m]}/$traj/${Outputs[$c]}/"
