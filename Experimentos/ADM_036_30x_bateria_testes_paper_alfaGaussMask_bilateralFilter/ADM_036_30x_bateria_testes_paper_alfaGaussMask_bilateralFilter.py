...
ConfigsName=[
"abBRIEF",
"MSabBRIEF_alfamsk_0,2",
"MSabBRIEF_alfamsk_0,4",  
"MSabBRIEF_alfamsk_0,5",
"MSabBRIEF_alfamsk_0,6", 
"MSabBRIEF_alfamsk_0,8",

"MSabBRIEF_alfamsk_0,2_bi", 
"MSabBRIEF_alfamsk_0,4_bi", 
"MSabBRIEF_alfamsk_0,5_bi",
"MSabBRIEF_alfamsk_0,6_bi"
"MSabBRIEF_alfamsk_0,8_bi"
]
...
for c in range(len(Configs)):
	...
	for m in range(len(Maps)):
		...
		for t in range(LenTraj):
			...
			errorXYZ[m][c].append(erroG/numTests)
...
for c in range(len(Configs)):
	for m in range(len(Maps)):
		plot(errorXYZ[m][c],color=cstyle[(c%len(cstyle))],linestyle=lstyle[(c%len(lstyle))],linewidth=2)
...
if printCorrigido == 1:
	for c in range(len(Configs)):
		for m in range(len(Maps)):
			...
			#if len(ConfigsName) > 1 and len(MapsName) > 1:
		#		legendNames.append(ConfigsName[c]+MapsName[m]+"__CORR")
		#	elif len(ConfigsName) > 1 and len(MapsName) == 1:			
		#		legendNames.append(ConfigsName[c]+"__CORR")
		#	elif len(ConfigsName) == 1 and len(MapsName) > 1:
		#		legendNames.append(MapsName[m]+"__CORR")
