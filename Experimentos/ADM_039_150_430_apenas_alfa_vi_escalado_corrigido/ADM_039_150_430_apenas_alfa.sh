...
execPath="../build-PhiR2Framework-Desktop_Qt_5_10_0_GCC_64bit5-Release/PhiR2Framework"
...
do
	...
	do
		...
		do
			...
			#####do                
                resultPath="/home/mathias/Workspace/Experimentos/ADM/0039/ADM_039_150_430_apenas_alfa_vi_escalado_corrigido/${MapsNames[$m]}/$traj/${Outputs[$c]}/"
